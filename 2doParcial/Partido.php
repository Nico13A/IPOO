...
public function __toString(){
    ...
    */
    public function darEquipoGanador() {
        $objEquipoGanador = null;
        if ($this->getCantGolesE1() > $this->getCantGolesE2()) {
            $objEquipoGanador = $this->getObjEquipo1();
        }
        elseif ($this->getCantGolesE1() < $this->getCantGolesE2()) {
            $objEquipoGanador = $this->getObjEquipo2();
        }
        else {
            $objEquipoGanador = [$this->getObjEquipo1(), $this->getObjEquipo2()];
        }
        return $objEquipoGanador;
    }
    ...
    */
    public function coeficientePartido() {
        $coefPartido = $this->getCoefBase() * ($this->getCantGolesE1() + $this->getCantGolesE2()) * ($this->getObjEquipo1()->getCantJugadores() + $this->getObjEquipo2()->getCantJugadores());
        return $coefPartido;
    }
